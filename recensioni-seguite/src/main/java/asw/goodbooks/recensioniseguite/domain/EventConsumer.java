...
public class EventConsumer {
    ...
    public void onEvent(DomainEvent event) {
        if (event.getClass().equals(RecensioniCreatedEvent.class)) {
            RecensioniCreatedEvent rce = (RecensioniCreatedEvent) event;
    ...
    private void onRecensioneCreated(RecensioniCreatedEvent event) {
